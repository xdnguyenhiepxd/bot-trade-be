...
export const BASE_PATH = "https://quote-api.jup.ag/v6".replace(/\/+$/, "");
...
export class BaseAPI {
    ...
    protected async request(context: RequestOpts, initOverrides?: RequestInit | InitOverrideFunction): Promise<Response> {
        ...
        console.log('Response returned an error code: ', response);
        return
    }
        ...
        try {
            ...
            if (response === undefined) {
              if (e instanceof Error) {
                console.log(e, 'The request failed and the interceptors did not return an alternative response');
                 return ;
              } else {
                console.log('[runtime] [fetchApi]', e)
                return ;
              }
            }
        }
